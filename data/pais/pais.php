...
if ($_POST['tipo'] == "g") {
    $repetidos = repetidos($conexion, "codigo_pais", $_POST['txt_1'], "pais", "g", "", "");
    if ($repetidos == 'true') {
    ...
    if ($_POST['tipo'] == "m") {
        $repetidos = repetidos($conexion, "codigo_pais", $_POST['txt_1'], "pais", "m", $_POST['txt_0'], 'id_pais');        
        if ($repetidos == 'true') {
            $data = "1"; /// este dato ya existe;
        } else {
            $repetidos = repetidos($conexion, "nombre_pais", $_POST['txt_2'], "pais", "m", ucwords(strtolower($_POST['txt_0'])), 'id_pais');        
