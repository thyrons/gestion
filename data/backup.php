<?php
  ...
  //C:\Program Files (x86)\PostgreSQL\9.2\bin>psql -U postgres -d prubea_g -p 5432 -h localhost < C:\Users\USER\Downloads gestion_documental_uniandes-2015-07-24 12-00-58.sql"///para el backup
  backup();
  ...
  function backup(){         
    ...
    auditoria_sistema($conexion,'auditoria_sistema',$id_user,'Backup',"",$fecha_larga,$fecha,"","","Backup de la base de datos");    
    //////////////  
    ...
    $max=$max+1;
    //////////////
    $dbname = "gestion_documental_uniandes";
