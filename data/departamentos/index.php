...
<html>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">          
          <h1>
            Ingreso Departamentos Administrativos            
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li class="active">Ingresos</li>
            <li class="active">Departamentos Administrativos</li>
          </ol>
        </section>
        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Formularios Departamentos Admistrativos</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" id="form_departamentos" class="form-horizontal" method="POST" action="">                
                  <div class="box-body col-md-12">                                                            
                    <div class="form-group">                      
                      <label for="txt_1" class="col-md-4">Cod. Departamento</label>
                      <div class="col-md-8">
                        <input type="text" class="form-control" id="txt_1"  name="txt_1" placeholder="Código Departamento" required pattern="[A-Za-záéíóúÁÉÍÓÚñÑ0-9 +()]{1,}" style="text-transform: uppercase;">
                        <input type="hidden" class="form-control" id="txt_0"  name="txt_0">
                      </div>
                    </div>                                                                              
                    <div class="form-group">                            
                      <label for="txt_2" class="col-md-4">Nom. Departamento</label>
                      <div class="col-md-8">
                        <input type="text" class="form-control" id="txt_2" name="txt_2" placeholder="Nombre Departamento" required pattern="[A-Za-záéíóúÁÉÍÓÚñÑ0-9 () ]{1,}">
                      </div>
                    </div>                                                                                                  
                  </div><!-- /.box-body -->
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Tabla Departamentos Administrativos</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="tabla_departamentos" class="table table-bordered table-hover">
                    <thead>
                      <th>ID</th>
                      <th>Código</th>
                      <th>Nombre</th>                      
    ...
    <script src="departamentos.js" type="text/javascript"></script>
