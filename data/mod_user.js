	...
	if($("#txt_1_clave").val() != '' && $("#txt_2_clave").val() != '' && $("#txt_3_clave").val() != ''){
		if(encode64($("#txt_1_clave").val()) == data[24]){
			if($("#txt_2_clave").val() == $("#txt_3_clave").val()){
				$.ajax({        
				    type: "POST",				    
				    data: {name:'txt_1_clave',value_1:$("#txt_1_clave").val(),value_2:$("#txt_2_clave").val(),value_3:$("#txt_3_clave").val()},
				    dataType: 'json',        
				    url: "../mod_user.php?id="+data[0],          
				    success: function(response) {         			        					    	
				        ...
				        if(response == 1){
				        	$.gritter.add({							
								...
								text: "Datos Actualizados... La página se recargara",
			...
			$.gritter.add({							
				title: 'Datos Enviados..!',							
				text: "La clave actual no es válida",
				image: '../../img/error.png',							
				sticky: false, 							
				time: 1000,									
				class_name: 'light',						        
		...
		$.gritter.add({							
			title: 'Datos Enviados..!',							
			text: "Llene todos lo campos antes de continuar",
			image: '../../img/error.png',							
			sticky: false, 							
			time: 1000,									
			class_name: 'light',						        			
