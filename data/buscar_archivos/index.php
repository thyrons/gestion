...
<html>
  ...
  <body class="skin-blue">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class=""><a href="../inbox/enviados.php" ><i class="fa fa-envelope-o"></i> Enviados <span class="label label-success pull-right" id="total_enviados"></span></a></li>       
    ...
    <script src="buscar_archivos.js" type="text/javascript"></script> 
