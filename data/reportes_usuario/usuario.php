                ...
                <form role="form" id="form_pais" class="form-horizontal" method="POST" action="">                
                  <div class="box-body col-md-12">                                                            
                    <div class="form-group">                                          
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          <label for="" class="col-md-2 control-label">Tipos de Archivos</label>
                          <div class="col-md-8">
                            <select id="tipo" class="form-control">
                              <option value="pdf"> Archivos PDF </option>
                              <option value="octet-stream"> Aplicaciones ejecutables </option>
                              <option value="zip"> Aplicaciones ZIP </option>
                              <option value="msword"> Archivos de word 2003 </option>
                              <option value="xls"> Archivos de excel 2003 </option>
                              <option value="xlsx"> Archivos de excel 2010 + </option>
                              <option value="ppt"> Archivos de power point 2003 </option>
                              <option value="pptx"> Archivos de power point 2010 + </option>
                              <option value="gif"> Imágenes gif </option>
                              <option value="png"> Imágenes png (image/png) </option>
                              <option value="jpg"> Imágenes jpeg (image/jpg) </option>
                              <option value="jpg"> Imágenes jpg (image/jpg) </option>
                              <option value="doc"> Microsoft Office Word 2010 </option>
                              <option value="docx"> Microsoft Office Word 2010 +</option>
                              <option value="vnd.openxmlformats-officedocument.wordprocessingml.template"> Microsoft Office Plantillas 2013 </option>
                              <option value="vnd.openxmlformats-officedocument.presentationml.presentation"> Microsoft Office Power Point 2013 </option>
                              <option value="vnd.openxmlformats-officedocument.spreadsheetml.sheet"> Microsoft Office Excel 2013 </option>
                            </select>
                          </div>
                          <div class="col-md-2">
