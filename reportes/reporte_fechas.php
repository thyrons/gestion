<?php
    ...
    if($_SESSION['tipo_user'] == '1'){
        $sql = "select id_archivo,nombre_archivo,codigo_archivo,fecha_creacion,estado from archivo order by fecha_creacion asc";
    }else{
        $sql = "select id_archivo,nombre_archivo,codigo_archivo,fecha_creacion,estado from archivo where fuente_usuario = '".$_SESSION['id_gestion']."' order by fecha_creacion asc";    
    }
    $sql = pg_query($sql);
    $repetido = 0;
